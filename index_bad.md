  ...
  <body>    
    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#hero" class="navbar-brand">Shreya Banerjee</a>
          </div>             
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#introduction">About me</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#work">Research & Outreach</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#contact">Publications</a>
              </li>  
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#contact">CV</a>
              </li>                   
            </ul>
          </div>        
        </div>
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Eco-evolutionary responses to environmental stress in marine systems</h2>
    ...
    <section id="about me" class="tm-section-pad-top">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <img src="img/shreya_w_limpet2.jpg" alt="Image" class="img-fluid tm-intro-img" />
          </div>
          <div class="col-lg-6">
            <div class="tm-intro-text-container">
                ...
                <p class="mb-5 tm-intro-text">
                  Check out my
                  <a rel="nofollow" href="https://scholar.google.com/citations?hl=en&user=XjKy0WEAAAAJ&view_op=list_works&sortby=pubdate">Google Scholar page</a>!</p>
            </div>
          </div>
        </div>
        ...
        <div class="row tm-section-pad-top">
          <div class="col-lg-4">
            ...
            <h4 class="text-center tm-text-primary mb-4">Climate-driven range shifts and adaptation</h4>
            <p>
    ...
    <section id="Research & Outreach" class="tm-section-pad-top">
      <div class="container tm-container-gallery">
        <div class="row">
          <div class="text-center col-12">
              <h2 class="tm-text-primary tm-section-title mb-4">Research & Outreach</h2>
                    ...
                    <div class="grid tm-gallery">
                      <a href="img/gallery-img-01.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Climate-driven range shifts</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-02.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Predicting environmental adaptation</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-03.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Thermal tolerance differences between cryptic species</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-04.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Anthropogenically mediated hybrid zones</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-05.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Invisible ecology field trip</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-06.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Marine Turtle Transcriptomics</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-01.jpg">
                      ...
                      <a href="img/gallery-img-02.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/gallery-tn-02.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Multiple paternity in leatherback turtles</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                    </div>
